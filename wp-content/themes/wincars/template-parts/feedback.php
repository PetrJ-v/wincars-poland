...
// $feedback_classes = ($animation) ? 'wow fadeInUp flipInY' : '';
$feedback_classes = ($animation) ? 'wow fadeInUp flipInX' : '';
$animation_delay = $args['animation_delay'];

?>
<div class="feedback <?php echo $feedback_classes; ?>" <?php if ($animation) echo sprintf('data-wow-duration="1.5s" data-wow-delay="%fs"', $animation_delay); ?> data-test="<?php echo $animation_delay; ?>">
	<?php
